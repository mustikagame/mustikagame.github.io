...
function allset(){
 ...
 msgs.innerHTML="Exploit sukses!";
}

function awaitpl() {
 msgs.innerHTML="GoldHEN sudah terbuka, BinLoader Siap.<br>Kirim Payload lewat port 9020";
}
...
function userland() {
 ...
 if (chain.syscall(20).low == 0) {
  alert("Webkit Exploit Gagal. Refresh halaman ini atau nyalakan ulang PS.");
  while (1);
 }
}
...
function kernelExploit() {
 ...
 var trigger_spray = function () {
  ...
  msgs.innerHTML="1. Masukkan Flashdisk!.<br>2. Tunggu sampai muncul notifikasi di pojok kiri atas dan tunggu sampai hilang.<br>3. Tekan Tombol MASUK dan tunggu hingga notifikasi GoldHEN muncul di pojok kiri atas.<br>4. Cabut Flashdisk dan tekan tombol PS di stick.";
  ...
  alert("Kernel Exploit Gagal! Matikan PS dan Ulangi lagi.");
  p.write8(0, 0);
  return;
